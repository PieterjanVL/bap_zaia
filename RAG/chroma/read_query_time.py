...
for i in neighbors:
    time_taken = timeit.timeit(lambda: read_query("What is the phone number of customer John Doe?", i), number=1)
    print(f"Neighbors: {i}, Time: {time_taken} seconds")

    with open('../analyse/query_db/chroma-query-time-384.csv', mode='a', newline='') as file:
